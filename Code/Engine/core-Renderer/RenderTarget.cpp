...
RCActivateRenderTarget::RCActivateRenderTarget( RenderTarget* renderTarget, uint targetIdx ) 
...
{
   renderer.bindRenderTarget( m_renderTarget, m_targetIdx );
}
...
RCDeactivateRenderTarget::RCDeactivateRenderTarget( uint targetIdx )
   : m_targetIdx( targetIdx )
{
}
...
{
   renderer.unbindRenderTarget( m_targetIdx );
}
