...
{
   // TODO: I think this was supposed to use 'set' method instead of 'setNormalized'.
   // Check it once Matrices are converted to SIMD
   outScaleVec.setNormalized( m_rows[0].m128_f32[0], m_rows[1].m128_f32[1], m_rows[2].m128_f32[2] );
}
