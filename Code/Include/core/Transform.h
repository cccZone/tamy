...
struct Transform
{
    ...
    * @param matrix
    */
   Transform& set( const Matrix& matrix );
    ...
    * @param b
    */
   Transform& setMul( const Transform& a, const Transform& b );
    ...
    * @param a
    */
   Transform& mul( const Transform& a );
    ...
    * @param a
    */
   Transform& preMul( const Transform& a );
    ...
    * @param rhs
    */
   Transform& setInverse( const Transform& rhs );
