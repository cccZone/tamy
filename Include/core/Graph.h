 ...
 * The only constraint is that an EDGE typ had the Graph::Index operator
...
public:
     ...
     *
     * @param nodeIdx       index of a node we want disonnected
     */
...
/**
 * A default node that does't contain any additional information
