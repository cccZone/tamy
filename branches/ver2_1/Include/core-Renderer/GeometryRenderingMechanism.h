...
/**
 * This class takes care of translating whatever's inside renderables
 * into a list of rendering commands that are executed
 * by an arbitrary rendering abstraction layer.
 */
class GeometryRenderingMechanism : public RenderingMechanism
{
private:
...
public:
    ...
    */
   GeometryRenderingMechanism(RenderingTargetsPolicy* policy, 
                          RendererImpl* impl);
   ~GeometryRenderingMechanism();
