...
GeometryRenderingMechanism::GeometryRenderingMechanism(RenderingTargetsPolicy* policy, 
                                               RendererImpl* impl)
: m_policy(policy)
...
GeometryRenderingMechanism::~GeometryRenderingMechanism()
{
   m_activeCamera = NULL;
...
void GeometryRenderingMechanism::setStorage(RenderablesStorage* storage)
{
   if (storage == NULL)
   {
...
void GeometryRenderingMechanism::setRenderingAction(RenderingAction* action)
{
   if (action == NULL)
   {
...
void GeometryRenderingMechanism::setActiveCamera(Camera& camera)
{
...
void GeometryRenderingMechanism::render()
{
