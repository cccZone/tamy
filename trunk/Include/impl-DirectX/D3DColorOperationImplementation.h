 ...
 */
class D3DColorOperationImplementation : public MaterialOperationImplementation
{
private:
   IDirect3DDevice9& m_d3Device;

public:
   D3DColorOperationImplementation(IDirect3DDevice9& d3Device);
...
private:
   D3DTEXTURESTAGESTATETYPE translateArgNum(unsigned char argIdx) const
   {
      ...
      switch (argIdx)
      {
      case 0: arg = D3DTSS_COLORARG1; break;
      case 1: arg = D3DTSS_COLORARG2; break;
