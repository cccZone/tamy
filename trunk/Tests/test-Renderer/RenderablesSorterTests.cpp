...
TEST(RenderablesSorter, sortingByMaterial)
{
   ...
   RenderablesSorter<RenderableNode> processor;
...
TEST(RenderablesSorter, transparentObjects)
{
   RendererImplementationMock renderer;
   Camera cameraNode("camera", renderer);
...
TEST(RenderablesSorter, transparentObjectsAreSortedWithRespectToCamera)
{
   RendererImplementationMock renderer;
   Camera cameraNode("camera", renderer);
   std::vector<std::string> results;
