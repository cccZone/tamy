...
MeshData* GeometryBuilder::createPrism()
{
   ...
   // prysm base
   result->vertices.push_back(LitVertex(-2, -2, -2, 1, 0, 0, 0, 0, -1, 0, 0));
   result->vertices.push_back(LitVertex(-2,  2, -2, 1, 0, 0, 0, 0, -1, 0, 0));
   result->vertices.push_back(LitVertex( 2,  2, -2, 1, 0, 0, 0, 0, -1, 0, 0));
   result->vertices.push_back(LitVertex( 2, -2, -2, 1, 0, 0, 0, 0, -1, 0, 0));
   ...
   // top side
   result->vertices.push_back(LitVertex(-2,  2, -2, 1, 0, 0, 0, 0.707f, 0.707f, 0, 0));
   result->vertices.push_back(LitVertex( 0,  0,  2, 1, 0, 0, 0, 0.707f, 0.707f, 0, 0));
   result->vertices.push_back(LitVertex( 2,  2, -2, 1, 0, 0, 0, 0.707f, 0.707f, 0, 0));
   result->indices.push_back(Face<USHORT>(4, 5, 6, 0));

   // right side
   result->vertices.push_back(LitVertex( 2,  2, -2, 1, 0, 0, 0.707f, 0, 0.707f, 0, 0));
   result->vertices.push_back(LitVertex( 0,  0,  2, 1, 0, 0, 0.707f, 0, 0.707f, 0, 0));
   result->vertices.push_back(LitVertex( 2, -2, -2, 1, 0, 0, 0.707f, 0, 0.707f, 0, 0));
...
MeshData* GeometryBuilder::createCube()
{
   ...
   // right face
   result->vertices.push_back(LitVertex( 2, -2, -2, 1, 0, 0, 1, 0, 0, 0, 0));
   result->vertices.push_back(LitVertex( 2,  2, -2, 1, 0, 0, 1, 0, 0, 0, 0));
   result->vertices.push_back(LitVertex( 2,  2,  2, 1, 0, 0, 1, 0, 0, 0, 0));
   result->vertices.push_back(LitVertex( 2, -2,  2, 1, 0, 0, 1, 0, 0, 0, 0));
   result->indices.push_back(Face<USHORT>(4, 5, 6, 0));
   ...
   // top face
   result->vertices.push_back(LitVertex(-2, 2, -2, 1, 0, 0, 0, 1, 0, 0, 0));
   result->vertices.push_back(LitVertex(-2, 2,  2, 1, 0, 0, 0, 1, 0, 0, 0));
   result->vertices.push_back(LitVertex( 2, 2,  2, 1, 0, 0, 0, 1, 0, 0, 0));
   result->vertices.push_back(LitVertex( 2, 2, -2, 1, 0, 0, 0, 1, 0, 0, 0));
